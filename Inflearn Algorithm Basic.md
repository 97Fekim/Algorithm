...
- 1) 무방향 그래프는 2,4 노드가 연결되어 있음을 표시할때, <code>graph[2][4] = 1; graph[4][2] = 1;</code><br>
- 2) 방향 그래프는 2,4 노드가 연결되어 있음을 표시할때, <code>graph[2][4] = 1;</code><br>
- 3) 가중치 방향 그래프는 2,4 노드가 7의 가중치로 연결되어 있음을 표시할때, <code>graph[2][4] = 7;</code><br>
